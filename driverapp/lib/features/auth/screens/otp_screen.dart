...
class _OtpScreenState extends ConsumerState<OtpScreen> {
  ...
  String get _maskedPhone {
    ...
    return '${digits.substring(0, 2)}${'*' * (digits.length - 5)}${digits.substring(digits.length - 3)}';
  }
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AuthState>(authProvider, (previous, next) {
      if (next is AuthError) {
        ...
        context.go('/home');
      } else if (next is AuthNeedsRegistration) {
    ...
    final focusedPinTheme = defaultPinTheme.copyWith(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: DeliveryColors.primary, width: 1.8),
        boxShadow: [
          BoxShadow(
    ...
    final submittedPinTheme = defaultPinTheme.copyWith(
      decoration: BoxDecoration(
        color: DeliveryColors.primaryBg,
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: DeliveryColors.primaryLight),
      ),
    );
    ...
    final errorPinTheme = defaultPinTheme.copyWith(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: DeliveryColors.newOrder),
      ),
    );
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            child: _GlowOrb(
              size: 180,
              color: DeliveryColors.bonusGold.withValues(alpha: 0.16),
            ),
          ),
          SafeArea(
                    ...
                    children: [
                      DecoratedBox(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: DeliveryColors.divider.withValues(
                              alpha: 0.9,
                            ),
                          ),
                        ),
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          ...
                          DeliveryColors.surface.withValues(alpha: 0.9),
                        ],
                      ),
                      borderRadius: BorderRadius.circular(30),
                      border: Border.all(
                        color: DeliveryColors.divider.withValues(alpha: 0.88),
                      ),
                      boxShadow: [
                        BoxShadow(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: DeliveryColors.primaryBg.withValues(
                              alpha: 0.72,
                            ),
                          ...
                          child: const Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Verification protects live dispatch access, route visibility, and payout controls.',
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w700,
                                    height: 1.45,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Verify once to access live dispatch, current routes, daily earnings, and delivery history.',
