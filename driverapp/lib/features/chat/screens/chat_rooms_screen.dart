...
import 'package:freshkart_delivery/core/models/chat_models.dart';
import 'package:freshkart_delivery/features/chat/providers/chat_provider.dart';
import 'package:freshkart_delivery/features/chat/screens/chat_screen.dart';
...
class _ChatRoomTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: room.orderId != null
          ? Text('Order #${room.orderId!.substring(0, 8)}')
          : null,
